...
class User(AbstractBaseUser, PermissionsMixin):
    USER_TYPE_ADMIN = 'A'
    USER_TYPE_COORDINATOR = 'C'
    USER_TYPE_TEAM_LEADER = 'TL'
   
    USER_TYPE_CHOICES = [
        (USER_TYPE_ADMIN, 'Admin'),
        (USER_TYPE_COORDINATOR, 'Coordinator'),
        (USER_TYPE_TEAM_LEADER, 'Team Leader'),
    ]
    ...
    user_type = models.CharField(
        max_length=2, choices=USER_TYPE_CHOICES, default=USER_TYPE_TEAM_LEADER)
